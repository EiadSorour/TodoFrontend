    ...
    return(
        <div className="main test">
            ...
            {todos.map( (todo)=>{
                return (
                    <div>
                        <li key={todo._id} className="list-group-item width-control position-relative">
                            ...
                            <label className="form-check-label mx-2" for={todo._id} style={ todo.isCompleted ? {textDecoration: "line-through"} : {} }>{todo.text}</label>
            ...
            {showBox?   <div>
                            <br/>
                            <input onChange={handleOnChange} class="form-control width-control d-inline" type="text" value={newTodo} aria-label="readonly input example" />
